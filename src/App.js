...
const CONTRACT_ADDRESS = "0xC1665587fac0934C09BDb11b8EB83157Fd99f4Ca";
...
// MyEpicNFT.sol の中で event が　emit された時に、情報を受け取ります。
const setupEventListener = async () => {
  ...
  const askContractToMintNft = async () => {
    const CONTRACT_ADDRESS =
      "0xC1665587fac0934C09BDb11b8EB83157Fd99f4Ca";
    try {
      const { ethereum } = window;
      if (ethereum) {
        const provider = new ethers.providers.Web3Provider(ethereum);
